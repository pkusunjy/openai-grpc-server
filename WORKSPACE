...
http_archive(
    ...
    sha256 = "6229189893ea9a03703753036f39a860cfc48e8739372f78d6c4237e19dbf36d",
    strip_prefix = "openai-server-proto-1.0.7",
    urls = ["https://github.com/pkusunjy/openai-server-proto/archive/v1.0.7.tar.gz"],
)
