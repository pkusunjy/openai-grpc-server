...
http_archive(
    ...
    sha256 = "7321afeb70ab08cbd7a5be22fb32ce36e867f31b0f2c87110b29591ac5efdef7",
    strip_prefix = "openai-server-proto-1.1.2",
    urls = ["https://github.com/pkusunjy/openai-server-proto/archive/v1.1.2.tar.gz"],
)
